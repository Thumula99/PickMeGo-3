    ...
    <div class="container">
            ...
            <form id="profileForm">
                ...
                <div class="form-group">
                    ...
                    <select id="vehicleType" name="vehicleType" required>
                        ...
                        <option value="Car" ${sessionScope.user.vehicleType == 'Car' ? 'selected' : ''}>Car</option>
                        <option value="SUV" ${sessionScope.user.vehicleType == 'SUV' ? 'selected' : ''}>SUV</option>
                        <option value="Van" ${sessionScope.user.vehicleType == 'Van' ? 'selected' : ''}>Van</option>
                        <option value="Truck" ${sessionScope.user.vehicleType == 'Truck' ? 'selected' : ''}>Truck</option>
                        <option value="Motorcycle" ${sessionScope.user.vehicleType == 'Motorcycle' ? 'selected' : ''}>Motorcycle</option>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="vehicleName">Vehicle Name/Model</label>
                    <input type="text" id="vehicleName" name="vehicleName" value="${sessionScope.user.vehicleName}" placeholder="e.g., Toyota Corolla, Honda Civic">
                </div>
        ...
        <div class="delete-confirmation" id="deleteConfirmation">
            ...
            <div class="btn-group">
                ...
                <button type="button" class="btn btn-primary" onclick="hideDeleteConfirmation()">
        ...
        document.getElementById('profileForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    document.getElementById('vehicleType').value = formData.get('vehicleType');
                    document.getElementById('vehicleName').value = formData.get('vehicleName');
                } else {
        ...
        function deleteAccount() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = '/ridebooking/views/login.jsp';
                    }, 2000);
                } else {
                    showAlert(data.message, 'error');
                }
